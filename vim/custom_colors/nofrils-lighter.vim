...
let g:colors_name = "nofrils-lighter"
...
hi Comment term=NONE cterm=NONE ctermfg=243 ctermbg=NONE gui=NONE guifg=#767676 guibg=NONE
...
hi CursorLineNr term=NONE cterm=NONE ctermfg=NONE ctermbg=231 gui=NONE guifg=NONE guibg=white
...
hi ErrorMsg term=NONE cterm=NONE ctermfg=9 ctermbg=231 gui=NONE guifg=#FF5555 guibg=white
hi Error term=NONE cterm=NONE ctermfg=9 ctermbg=231 gui=NONE guifg=#FF5555 guibg=white
hi IncSearch term=NONE cterm=NONE ctermfg=231 ctermbg=2 gui=NONE guifg=white guibg=#008000
hi MatchParen term=NONE cterm=NONE ctermfg=231 ctermbg=4 gui=NONE guifg=#ffffff guibg=#000080
...
hi Search term=NONE cterm=NONE ctermfg=231 ctermbg=6 gui=NONE guifg=white guibg=#00CDCD
hi StatusLine term=NONE cterm=NONE ctermfg=231 ctermbg=16 gui=NONE guifg=white guibg=#000000
hi Todo term=NONE cterm=NONE ctermfg=2 ctermbg=NONE gui=NONE guifg=#008000 guibg=NONE
hi WarningMsg term=NONE cterm=NONE ctermfg=9 ctermbg=231 gui=NONE guifg=#FF5555 guibg=white
hi WildMenu term=NONE cterm=NONE ctermfg=16 ctermbg=231 gui=NONE guifg=#000000 guibg=white
...
function! NofrilsFocusComments()
    hi Comment term=NONE cterm=NONE ctermfg=16 ctermbg=NONE gui=NONE guifg=#A8A8A8 guibg=NONE
...
function! NofrilsFocusCode()
    hi Comment term=NONE cterm=NONE ctermfg=243 ctermbg=NONE gui=NONE guifg=#A8A8A8 guibg=NONE
    hi Normal term=NONE cterm=NONE ctermfg=16 ctermbg=231 gui=NONE guifg=#000000 guibg=#FFFFFF
    hi LineNr term=NONE cterm=NONE ctermfg=248 ctermbg=bg gui=NONE guifg=#A8A8A8 guibg=NONE
    hi Character term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
    hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
    ...
    if g:nofrils_strbackgrounds
        ...
        hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=254 gui=NONE guifg=NONE guibg=#DADADA
    end
endfunction
...
function! NofrilsNormal()
    ...
    if g:nofrils_strbackgrounds
        hi Character term=NONE cterm=NONE ctermfg=NONE ctermbg=254 gui=NONE guifg=NONE guibg=#e4e4e4
        hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=254 gui=NONE guifg=NONE guibg=#e4e4e4
    end
    if g:nofrils_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=89 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
