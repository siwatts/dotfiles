...
let g:colors_name = "really-off"

if !exists("g:really_off_strhighlights")
    let g:really_off_strhighlights = 1
endif
if !exists("g:really_off_heavycomments")
    let g:really_off_heavycomments = 1
endif
if !exists("g:really_off_heavylinenumbers")
    let g:really_off_heavylinenumbers = 1
endif

set background=dark

" Baseline
hi Normal term=NONE cterm=NONE gui=NONE guifg=#eeeeee guibg=#262626
...
hi LineNr term=NONE cterm=NONE ctermfg=8 gui=NONE guifg=#808080 guibg=bg
...
hi StatusLineNC term=NONE cterm=NONE ctermbg=242 gui=NONE guibg=#6C6C6C
...
hi StatusLine term=NONE cterm=NONE ctermfg=black ctermbg=254 gui=NONE guifg=black guibg=fg
hi Todo term=NONE cterm=NONE ctermfg=10 ctermbg=NONE gui=NONE guifg=#00FF00 guibg=black
hi WarningMsg term=NONE cterm=NONE ctermbg=52 gui=NONE guibg=#5F0000
hi WildMenu term=NONE cterm=NONE ctermbg=black gui=NONE guibg=black
...
hi TabLineFill term=NONE cterm=NONE ctermbg=242 gui=NONE guibg=#6C6C6C
...
" Helper Functions
function! ReallyOffFocusComments()
...
function! ReallyOffNormal()
    ...
    if g:really_off_strhighlights
        hi Character term=NONE cterm=NONE ctermfg=11 ctermbg=NONE gui=NONE guifg=NONE guibg=#121212
        hi String term=NONE cterm=NONE ctermfg=10 ctermbg=NONE gui=NONE guifg=NONE guibg=#121212
    end
    if g:really_off_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=14 ctermbg=NONE gui=NONE guifg=#AF5FFF guibg=NONE
    end
    if g:really_off_heavylinenumbers
        hi LineNr term=NONE cterm=NONE ctermfg=11 ctermbg=NONE gui=NONE guifg=#AF5FFF guibg=NONE
    end
endfunction

" Setup normal settings
call ReallyOffNormal()
