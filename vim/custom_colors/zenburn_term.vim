...
hi Comment         guifg=#7f9f7f gui=italic                   ctermfg=2
...
hi Float           guifg=#c0bed1                              ctermfg=13
hi FoldColumn      guifg=#93b3a3 guibg=#3f4040
hi Folded          guifg=#93b3a3 guibg=#3f4040
hi Function        guifg=#efef8f                              ctermfg=11
...
"hi Number          guifg=#8cd0d3                              ctermfg=14
hi Number          guifg=#8cd0d3                              ctermfg=6
...
" String should actually be ctermfg=1, but 9 is brighter and fits the brighter
" comments and other colours. If comment set to 2, set string to 1, and other
" colours to match
...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi Normal        guifg=#dcdccc guibg=#3f3f3f           ctermfg=7   ctermbg=0
