...
let g:colors_name = "nofrils-darker"
...
hi LineNr term=NONE cterm=NONE ctermfg=244 ctermbg=bg gui=NONE guifg=#808080 guibg=bg
...
hi VertSplit term=NONE cterm=NONE ctermfg=16 ctermbg=242 gui=NONE guifg=black guibg=#6C6C6C
...
hi CursorLineNr term=NONE cterm=NONE ctermfg=NONE ctermbg=16 gui=NONE guifg=NONE guibg=black
...
hi IncSearch term=NONE cterm=NONE ctermfg=16 ctermbg=green gui=NONE guifg=black guibg=green
...
hi Search term=NONE cterm=NONE ctermfg=16 ctermbg=6 gui=NONE guifg=black guibg=#00CDCD
hi StatusLine term=NONE cterm=NONE ctermfg=16 ctermbg=fg gui=NONE guifg=black guibg=fg
...
hi WildMenu term=NONE cterm=NONE ctermfg=fg ctermbg=16 gui=NONE guifg=fg guibg=black
...
function! NofrilsNormal()
    ...
    if g:nofrils_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=117 ctermbg=NONE gui=NONE guifg=#AF5FFF guibg=NONE
    end
    if g:nofrils_heavylinenumbers
        hi LineNr term=NONE cterm=NONE ctermfg=117 ctermbg=NONE gui=NONE guifg=#AF5FFF guibg=NONE
    end
endfunction
