...
let g:colors_name='gruvbox_term'
...
"let s:gb.light0_white = ['#eeeeee', 255]     " V. light grey
...
let s:gb.bright_red     = ['#fb4934', 9]     " 251-73-52
let s:gb.bright_green   = ['#b8bb26', 10]     " 184-187-38
let s:gb.bright_yellow  = ['#fabd2f', 11]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 12]     " 131-165-152
let s:gb.bright_purple  = ['#d3869b', 13]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 14]     " 142-192-124
let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25

let s:gb.neutral_red    = ['#cc241d', 9]     " 204-36-29
let s:gb.neutral_green  = ['#98971a', 10]     " 152-151-26
let s:gb.neutral_yellow = ['#d79921', 11]     " 215-153-33
let s:gb.neutral_blue   = ['#458588', 12]      " 69-133-136
let s:gb.neutral_purple = ['#b16286', 13]     " 177-98-134
let s:gb.neutral_aqua   = ['#689d6a', 14]      " 104-157-106
let s:gb.neutral_orange = ['#d65d0e', 166]     " 214-93-14

let s:gb.faded_red      = ['#9d0006', 1]      " 157-0-6
let s:gb.faded_green    = ['#79740e', 2]     " 121-116-14
let s:gb.faded_yellow   = ['#b57614', 3]     " 181-118-20
let s:gb.faded_blue     = ['#076678', 4]      " 7-102-120
let s:gb.faded_purple   = ['#8f3f71', 5]      " 143-63-113
let s:gb.faded_aqua     = ['#427b58', 6]      " 66-123-88
